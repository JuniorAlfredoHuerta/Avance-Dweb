...
export class ExplorerService {
  ...
  getTPByTidandPId(idt: number, idp:number  ){
    return this.http.get(this.API+'tienda_producto'+'/'+idt+'/'+idp)

  }

  gettiendabyid(idt: number){
    return this.http.get(this.API+'tienda'+'/'+idt)
  }

  getproductobyid(idp: number){
    return this.http.get(this.API+'producto'+'/'+idp)
  }
